...
export const series = [
  ...
  new Serie(
    ...
    "./lib/images/orange-is-the-new-black.jpg"
  ),
  ...
  new Serie(
    ...
    "./lib/images/the-big-bang-theory.jpg"
  ),
  ...
  new Serie(
    ...
    "./lib/images/a-very-english-scandal.jpg"
  )
];
